...
const Header = ({ active, onNavigate }: Props) => {
      ...
      <div className="mx-auto max-w-6xl px-6 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-1.5">
          <a
            ...
            className="flex items-center justify-center w-9 h-9 rounded-full border border-white/[0.06] bg-white/[0.02] backdrop-blur-xl text-white/50 hover:text-cyan-400 hover:border-cyan-400/30 transition-colors"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-9 h-9 rounded-full border border-white/[0.06] bg-white/[0.02] backdrop-blur-xl text-white/50 hover:text-blue-400 hover:border-blue-400/30 transition-colors"
